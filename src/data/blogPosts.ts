...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      {
        type: 'heading',
        content: 'How Rx Supports Your Safety Mission'
      },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    excerpt: 'Take a behind-the-scenes look at how Rx transforms ideas into market-ready smart products through our proven 5-step development process.',
    date: 'May 15, 2025',
    author: 'Rx Technologies',
    category: 'Process',
    ...
    metaDescription: 'Learn about Rx proven 5-step process for developing smart products from initial concept to market launch. Discover how we turn ideas into reality.',
    content: [
      {
        type: 'paragraph',
        content: 'At Rx, we simplify the journey from an idea to a finished smart product. Whether you\'re starting from scratch or already have a clear concept ready to scale, we\'re here to support you exactly where you need us.'
      },
      {
        type: 'paragraph',
      ...
      {
        type: 'paragraph',
        content: 'Finally, it\'s launch day. You introduce your smart glove, thoroughly tested and production-ready, to the market. Rx provides ongoing support to ensure a smooth launch—from technical documentation to supporting the app\'s release.'
      },
      {
        type: 'heading',
        content: 'Why Choose Rx?'
      },
      {
        type: 'paragraph',
