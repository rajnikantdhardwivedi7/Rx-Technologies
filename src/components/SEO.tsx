...
const SEO: React.FC<SEOProps> = ({
  title = 'Rx',
  description = 'Rx Technologies: Pioneering smart engineering solutions with textile sensors for sports, safety, and performance monitoring.',
  type = 'website',
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="Rx Technologies" />
      ...
      <meta name="twitter:site" content="@rxtechnologies" />
      <meta name="twitter:creator" content="@rxtechnologies" />
