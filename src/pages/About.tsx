              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                ...
                >
                  ...
                  <p className="text-gray-600">
                    At Rx Technologies, we're on a mission to transform ordinary textiles into intelligent, 
                  ...
                  {[
                    {
                      ...
                      role: "Founder & CEO",
                      bio: "Leading Rx Technologies with a vision to transform the future of smart textiles.",
                      image: "/lovable-uploads/rajnikant-profile.jpg"
                    },
                    {
                      name: "Niek Bijman",
                      role: "Software Lead",
