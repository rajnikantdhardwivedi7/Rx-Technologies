...
const SportRetailProject = () => {
  return (
    ...
    >
      <SEO 
        title="Rx - Performance Athletic Footwear Project" 
      ...
      <div className="bg-gray-50 p-6 rounded-lg mb-8">
        ...
        <p>
          A global sports retail leader approached Rx Technologies with a vision to revolutionize the development, 
      ...
      <h3 className="text-2xl font-semibold mb-4 mt-8">Solution</h3>
        <p>
          Rx Technologies developed a comprehensive smart footwear R&D platform that includes:
      </p>
      ...
      <div className="bg-blue-50 p-6 rounded-lg mt-8 flex items-start">
        ...
        <div>
          ...
          <p>
            Rx Technologies continues to partner with this client on this R&D initiative to refine the prototype and 
