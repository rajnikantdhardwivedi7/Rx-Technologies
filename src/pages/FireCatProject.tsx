...
const FireCatProject = () => {
  return (
    <ProjectPageLayout
      ...
      darkMode={true}
    >
      <h2 className="text-3xl font-bold mb-6">Case Study: FireCat's 6th SENSE by Rx Technologies</h2>
      ...
      <h3 className="text-2xl font-semibold mb-4 mt-8">Solution</h3>
        <p>
          Rx Technologies provided an end-to-end solution called the 6th SENSE, combining sophisticated AI-driven 
      ...
      <h3 className="text-2xl font-semibold mb-4 mt-8">Outcome</h3>
        <p>
          ...
          safety, and operational efficiency of high-risk personnel. Rx's innovative platform and specialized 
